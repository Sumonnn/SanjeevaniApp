 ...
 * @author sumon
 */
public class ViewAllPatientFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllPatientFrame2
     */
     private DefaultTableModel model;
    public ViewAllPatientFrame2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllPatientFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllPatientFrame2().setVisible(true);
            }
        });
    }
    ...
    private void loadAllPatientDetails() {
       try{
            ...
            JOptionPane.showMessageDialog(null,"Error In DB in ViewAllpatientFrame2:"+ex.getMessage());
            ex.printStackTrace();
